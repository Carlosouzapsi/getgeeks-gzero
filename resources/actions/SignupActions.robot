...
Go To Signup form
    ...
    #### Criando um check-point para ver se está navegando para page correta:
...
User Should Be Registered
    ${expected_messagem}  Set Variable   css=p >> text=Agora você faz parte da Getgeeks. Tenha uma ótima experiência.

    Wait For Elements State  ${expected_messagem}   visible  5
